...
Når denne fil køres genereres trace.nc og ppc.nc lokalt, så modellen ikke trænes ved hvert kald
...
def weibull(df, draws=500, tune=500, chains=2):
    ...
    with pm.Model() as model:
        ...
        a = pm.HalfNormal('a', sigma=1)  # halfnormal er normalfordelingen med afskæring i 0
