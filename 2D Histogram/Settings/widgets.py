...
from PyQt5.QtWidgets import (
    QLabel, QFrame, QPushButton, QSlider, QLineEdit, QComboBox,
)
...
class NoScrollComboBox(QComboBox):
    """QComboBox that ignores scroll-wheel events so hovering + scrolling
    doesn't accidentally change the selected item."""
